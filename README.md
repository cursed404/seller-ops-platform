...
Это учебный backend-проект про обработку операционных инцидентов в продаже через маркетплейсы. Система принимает инцидент, поднимает нужный контекст, выбирает подходящий сценарий действий, при необходимости ждет подтверждение и сохраняет всю историю выполнения.
